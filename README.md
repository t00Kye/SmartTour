...
生成的 HAP 包位于：`entry/build/default/outputs/default/entry-default-unsigned.hap`
...
详细的上线流程请参考 [项目上线说明文档](./docs/项目上线说明.md)

## 常见问题

### Q: 应用无法安装？
A: 请检查设备系统版本是否满足要求，并确保已开启开发者模式。

### Q: 部分功能无法使用？
A: 部分功能需要后端服务支持，当前版本为演示版本。

### Q: 如何调试应用？
A: 使用 DevEco Studio 的调试功能，或使用 `hdc` 工具进行命令行调试。
